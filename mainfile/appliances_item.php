        ...
        <div class="body_main clear">
            <div class="body_sub clear">
                ...
                <ul>
                    ...
                    <li><a href="appliances_item.php" class="active">APPLIANCES</a></li>
                ...
                <div class="container clear">
                    <div class="container_menu clear">
                        <ul>
                            ...
                            <li><a href="../index.php" class="active">Popular Products</a></li>
                            <li><a href="men_item.php" >Men's Products</a></li>
                            <li><a href="phone_item.php" >Smart Electronics</a></li>
                        </ul>
                    </div>
