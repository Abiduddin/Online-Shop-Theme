    ...
    <body>
        ...
        <div class="navigation_main clear">
            ...
            <div class="navigation_sec clear">
                ...
                <li><a href="mainfile/dev.php">DEVELOPER</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="body_main clear">
            <div class="body_sub clear">
                ...
                <ul>
                    ...
                    <li><a href="mainfile/men_item.php">MEN'S FASHION</a></li>
                    <li><a href="mainfile/phone_item.php">PHONES & TABLETS</a></li>
                    <li><a href="mainfile/tv_item.php">TV, AUDIO & CAMERAS</a></li>
                    <li><a href="mainfile/computer_item.php">COMPUTING & GAMMING</a></li>
                    <li><a href="mainfile/appliances_item.php">APPLIANCES</a></li>
                    <li><a href="mainfile/home_item.php">HOME & LIVING</a></li>
                    <li><a href="mainfile/sports_item.php">SPORTS & TRAVEL</a></li>
                    <li><a href="mainfile/baby_item.php">BABY , KIDS & TOYS</a></li>
                ...
                <div class="container clear">
                    <div class="container_menu clear">
                        <ul>
                            ...
                            <li><a href="mainfile/men_item.php">Men's Products</a></li>
                            <li><a href="mainfile/phone_item.php">Smart Electronics</a></li>
                        </ul>
                    </div>
